        ...
        <div className='flex flex-col bg-white w-[90%] mx-auto rounded-lg p-6 '>
            ...
            <ul className='flex flex-col gap-4'>
                <li className='flex text-[#3f4254] mt-4'>
                    <label 
                        className='after:content-["*"] after:text-[#f1416c] text-[1.075rem] font-light after:pl-0.5 max-w-[50%] w-full'
                    >
                        Full Name
                    </label> 
                ...
                <li className='flex text-[#3f4254] '>
                    ...
                    <input 
                        type='text' 
                        defaultValue={settingsUser?.user?.number !== null ? settingsUser?.user?.number : 'Não informado'}
                ...
                <li className='flex text-[#3f4254]'>
                    ...
                    <input 
                        defaultValue={settingsUser?.user?.email !== null ? settingsUser?.user?.email : 'Não informado'}
                        type='text' 
                        className=' text-[#5e6278] bg-[#f5f8fa] rounded-md p-2 max-w-[50%] w-full'
                    >
                    </input>
                ...
                <li className='flex text-[#3f4254]'>
                    ...
                    <input 
                        defaultValue={settingsUser?.user?.status !== null ? settingsUser?.user?.status : 'Não informado'}
                        type='text' 
                        className=' text-[#5e6278] bg-[#f5f8fa] rounded-md p-2 max-w-[50%] w-full'
                    >
                    </input>
                ...
                <li className='flex text-[#3f4254] w-full'>
                    ...
                    <input 
                        defaultValue={settingsUser?.user?.payments === null ? settingsUser?.user?.payments : 'Não informado'}
                        type='text' 
                        className=' text-[#5e6278] bg-[#f5f8fa] rounded-md p-2 max-w-[50%] w-full'
                    ></input>
                </li>
