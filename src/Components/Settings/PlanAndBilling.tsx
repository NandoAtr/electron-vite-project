...
const subNavigation = [
  { name: "Profile", href: "#", icon: FaUserCircle, current: false },
  { name: "Account", href: "#", icon: IoIosSettings, current: false },
  { name: "Devices", href: "#", icon: GoDeviceDesktop, current: false },
  { name: "Password", href: "#", icon: HiOutlineKey, current: false },
  { name: "Notifications", href: "#", icon: IoMdNotifications, current: false },
  { name: "Plan & Billing", href: "#", icon: TbCreditCard, current: true },
];
const plans = [
  {
    name: "Startup",
